if (game:GetService("CoreGui")):FindFirstChild("VELOCTIY") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).VELOCTIY:Destroy();
...
ImageButton.Image = "rbxassetid://84895930961309";
